...
def generate_launch_description():
    ...
    rviz_config_file = LaunchConfiguration("rviz_config_file", default="hunter_se.rviz")
    use_sim_time = LaunchConfiguration("use_sim_time", default="true")
    x_pose = LaunchConfiguration("x_pose", default="0.0")
    y_pose = LaunchConfiguration("y_pose", default="0.0")
    yaw_pose = LaunchConfiguration("yaw_pose", default="0.0")
    world_name = LaunchConfiguration("world_name", default="obstacles_easy.world")
    ...
    # Set GAZEBO environment variables so package:// mesh URIs resolve
    ...
    namespaced_rviz_config_file = ReplaceString(
        source_file=PathJoinSubstitution(
            [get_package_share_directory("hunter_se_description"), "rviz", rviz_config_file]
        ),
    ...
    robot_state_publisher_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(launch_file_dir, "hunter_se_robot_state_publisher.launch.py")
        ),
    ...
    robot_spawn_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(launch_file_dir, "spawn_hunter_se.launch.py")
        ),
        launch_arguments={
            "namespace": namespace,
            "x_pose": x_pose,
